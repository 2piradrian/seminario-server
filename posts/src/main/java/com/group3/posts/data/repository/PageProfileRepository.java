...
import com.group3.posts.data.datasource.page_profiles_server.repository.PageProfilesServerRepositoryI;
...
public class PageProfileRepository implements PagesRepositoryI {
    ...
    public PageProfile getById(String id, String token) {
        GetPageByIdRes response = this.repository.getById(id, token);
