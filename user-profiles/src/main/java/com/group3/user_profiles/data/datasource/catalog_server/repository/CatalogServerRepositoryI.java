package com.group3.user_profiles.data.datasource.catalog_server.repository;

import com.group3.user_profiles.config.beans.LoadBalancerConfiguration;
import com.group3.user_profiles.data.datasource.catalog_server.responses.instrument.GetAllInstrumentRes;
import com.group3.user_profiles.data.datasource.catalog_server.responses.instrument.GetInstrumentByIdRes;
import com.group3.user_profiles.data.datasource.catalog_server.responses.instrument.GetInstrumentListByIdRes;
import com.group3.user_profiles.data.datasource.catalog_server.responses.style.GetAllStyleRes;
import com.group3.user_profiles.data.datasource.catalog_server.responses.style.GetStyleByIdRes;
import com.group3.user_profiles.data.datasource.catalog_server.responses.style.GetStyleListByIdRes;
